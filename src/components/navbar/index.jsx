	...
	V67.5h22.5c6.067,0,11.537-3.655,13.858-9.26C218.68,52.635,217.397,46.184,213.107,41.894z"/>
            ...
            <div className='flex flex-row flex-nowrap w-full items-center justify-between bg-[#1B1B1B] z-10 text-[#fbf7f7] fixed top-0 ssm:my-[0px]'>
                ...
                <div className='flex flex-row flex-nowrap items-center justify-center gap-4 md:px-14 mx-[20px] ssm:mx-[4px] md:w-auto ssm:text-sm'>
                    <a  aria-label="link" href='#about' className='duration-[400ms] text-[#BECACA] text-lg font-bold py-2 hover:text-[#08D4F8] hover:scale-[1.05] ssm:text-sm'>
                        About
                    </a>
                    <a aria-label="link" href='#events' className='hover:scale-[1.05] duration-[400ms] text-[#BECACA] text-lg font-bold py-2 hover:text-[#08D4F8] ssm:text-sm'>
                        Events
                    </a>
                    <a  aria-label="link" href='#footer' className='text-lg duration-[400ms] font-bold py-2 text-[#08D4F8] border-2 border-[#08D4F8] transition transform hover:scale-110 hover:bg-[#08D4F8] hover:text-[#1B1B1B] duration-150 px-2 md:px-5 my-5 md:my-0 rounded-lg ssm:text-sm ssm:my-[0px]'>
                        Contact Us
                    </a>
                </div>
            </div>
