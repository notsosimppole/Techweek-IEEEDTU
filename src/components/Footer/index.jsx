                ...
                <div className='content-center footer1'>
                    ...
                    <div>
                        ...
                        <div className='flex flex md:flex-row items-center justify-start'>
                            <a aria-label="link" href='https://goo.gl/maps/otEPWNLtnYi928Sz6' target='_blank' rel='noreferrer'>
                            ...
                            <div className=' bscflex flex-col items-start justify-center'>
                                ...
                                <p className='text-[#BECACA] mx-4 text-md'>
                                    <a aria-label="link" href='https://www.dtu.ac.in/' target='_blank' rel='noreferrer' className='hover:text-[#08D4F8] bsc'>www.dtu.ac.in</a>
                                </p>
                                <p className='text-[#BECACA] mx-4 text-md'>
                                    <a aria-label="link" href='https://www.ieeedtu.in' target='_blank' rel="noreferrer" className='hover:text-[#08D4F8] bsc'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className='flex items-center justify-start'>
                            ...
                            <div>
                                ...
                                <p className='text-[#BECACA] mx-4 text-md bsc'>
                                    <a aria-label="link" href='https://wa.me/919899133065?text=' target='_blank' rel='noreferrer' className='hover:text-[#08D4F8]'>+91 98991 33065</a>
                                </p>
                            </div>
                        </div>
                        <div className='flex items-center justify-start bsc'>
                            ...
                            <div>
                                ...
                                <p className='text-[#BECACA] mx-4 text-md bsc'>
                                    <a aria-label="link" href='https://wa.me/918826978278?text=' target='_blank' rel='noreferrer' className='hover:text-[#08D4F8]'>+91 88269 78278</a>
                                </p>
                            </div>
                        </div>
                        <div className='flex items-center justify-start bsc'>
                            ...
                            <div>
                                ...
                                <p className='text-[#BECACA] mx-4 text-md'>
                                    <a  aria-label="link" href='https://wa.me/919625893430?text=' target='_blank' rel='noreferrer' className='hover:text-[#08D4F8]'>+91 96258 93430</a>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='text-[#BECACA] mx-4 text-md flex flex-col items-start justify-start '>
                        ...
                        <span className='flex items-center justify-between'>
                            ...
                            <a aria-label="link" href='https://www.linkedin.com/in/gitansh-mehta/' target='_blank' rel='noreferrer' className='pt-1'>
                ...
                <div className='py-2 mb-[20px]'>
                    ...
                    <div className='flex justify-between items-center mx-10 text-sm pt-8 disf2   '>
                        ...
                        <div className='flex items-center justify-center gap-[20px] margin-bottom-footer2'>
                            <a  aria-label="link" href='https://www.facebook.com/ieeedtu/' target='_blank' rel='noreferrer'>
...
<path d="M12 2.03998C6.5 2.03998 2 6.52998 2 12.06C2 17.06 5.66 21.21 10.44 21.96V14.96H7.9V12.06H10.44V9.84998C10.44 7.33998 11.93 5.95998 14.22 5.95998C15.31 5.95998 16.45 6.14998 16.45 6.14998V8.61998H15.19C13.95 8.61998 13.56 9.38998 13.56 10.18V12.06H16.34L15.89 14.96H13.56V21.96C15.9164 21.5878 18.0622 20.3855 19.6099 18.57C21.1576 16.7546 22.0054 14.4456 22 12.06C22 6.52998 17.5 2.03998 12 2.03998Z"/>
                            ...
                            <a  aria-label="link" href='https://www.instagram.com/ieee.dtu/' target='_blank' rel='noreferrer'>
                            ...
                            <a aria-label="link" href='https://twitter.com/dtu_ieee' target='_blank' rel='noreferrer'>
